...
def decode_execution_providers(execution_providers: List[str]) -> List[str]:
	logger.info(f'[ FACE_FUSION ] execution_providers: {execution_providers}', __name__.upper())
	...
	logger.info(f'[ FACE_FUSION ] encoded_execution_providers: {encoded_execution_providers}', __name__.upper())
